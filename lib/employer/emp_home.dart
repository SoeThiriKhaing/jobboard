...
class EmployerHomePage extends StatefulWidget {
  ...
  const EmployerHomePage({Key? key, required this.employerEmail}) : super(key: key);
              ...
              child: ElevatedButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => ManagePostsPage(employerEmail: widget.employerEmail),
                    ),
                  );
                },
                child: Center(
              ...
              child: ElevatedButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => CompanyProfilePage(employerEmail: widget.employerEmail),
                    ),
                  );
                },
                child: Text(
              ...
              child: ElevatedButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => StatisticsPage(employerEmail: widget.employerEmail),
                    ),
                  );
                },
                child: Text(
