...
Future<String?> _postJob() async {
  ...
  if (_formKey.currentState!.validate()) {
    try {
      ...
      final jobPostRef = FirebaseFirestore.instance.collection('job_posts').doc();
...
//   const JobPostForm({Key? key, required this.employerEmail}) : super(key: key);
...
//           'endingDate': _endingDateController.text,
//           'companyLogo': logoUrl,
//           'email': widget.employerEmail, // Added to link job post to employer
//         });
